...
function formatPhoneNumber(input) {
  ...
  function validateAndCreateContact() {
    ...
    if (!validatePhoneFormat(phoneInput)) {
  ...
  function validateAndUpdateContact() {
    ...
    const emailEditInput = document.getElementById('email-edit').value;
    if (!isValidEmail(emailEditInput)) {
      document.getElementById('edit-contact-result').textContent = 'Please enter a valid email.';
      document.getElementById('edit-contact-result').style.color = 'red';
      return false;
    }
    // If valid, continue with original function
